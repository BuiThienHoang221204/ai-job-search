...
/** Trung VỊ chứ không phải trung bình: một vị trí lương ngoại lệ không được kéo lệch cả nhóm. */
...
/** Bỏ cả `null` lẫn số 0 — 0 ở nguồn nghĩa là "không có số", không phải "lương bằng 0". */
